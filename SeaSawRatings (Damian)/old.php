...
<body>
      ...
      <div class ="well" id = "instructionsbox">
        ...
        <div id="myCarousel" class="carousel slide" data-interval="false">
          ...
          <div class="carousel-inner">
            ...
            <div class="item">
              First, you will see a series of images. You will spend at least five seconds viewing each image, but you can take as long as you want.
            <div class="item">
              After viewing all the images once, you will see them again, this time along with a slider representing your aesthetic response. Simply move the indicator to the location you feel most fitting, and a button will appear, allowing you to save your response and progress to the next trial.
            </div>
            <div class="item">
              There is no time limit, so feel free to view each image as long as you desire before progressing. <br><br> Please click the button below to begin!
            </div>
          </div>
  ...
  <script id="experimentScript">
    ...
    function RunExperiment(){
    	if (flowControl.ExperimentPart == 1){
        clearLoadingData();
        RunInstructions();
      }
    	else if (flowControl.ExperimentPart == 2) {
        RunTrial(trialAssets);
      }
      else if (flowControl.ExperimentPart == 3) {
